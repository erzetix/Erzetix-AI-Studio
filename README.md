...
Демонстрационное исполнение клиентского дашборда — в каталоге [demo](demo/): разделы, режимы утверждения и гостевой вход в рабочем виде, на предустановленном наборе данных.
